...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="/inventario/Assets/css/loading.css">
        <style>
                .modal-mask {
  position: fixed;
  z-index: 9998;
...
.modal-leave-active .modal-container {
  ...
  transform: scale(1.1);
        ...
        <div class="container">
            <div class="row" style="background: #fafafa">
                <!--<div class="col-md-12 col-12">-->
                    <div class="col-md-4" >
                        <img src="/inventario/Assets/images/logo.png" style="height:80px">
                    </div>                
                    <div class="col-md-4 text-center">
                        <h1>INVENTARIO</h1>
                    </div>  					            
                    <div class="col-md-4 text-right" style="padding-top:10px">
                        <img src="/inventario/Assets/images/user.png" style="height:30px"/><div id="nameuser"></div><div><a href="javascript:closeSession()">Salir[X]</a></div>
                    </div>   
                <!--</div>-->
            </div>
    ...
    <script src="/inventario/Assets/js/vue.min.js"></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/axios/0.18.0/axios.js"></script>
    <script src="/inventario/Assets/js/inventarioLectorBarras.js"></script>
    <script src="/inventario/Assets/js/components/dinamicItems.js"></script>
    </body>
</html>