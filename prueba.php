...
.modal-leave-active .modal-container {
  ...
  transform: scale(1.1);
            ...
            <div class="row" style="background: #fafafa">
                <div class="col-md-12">
                    <div class="col-md-2 col-md-offset-1" >
                        <img src="/inventario/Assets/images/logo.png" style="width:100%; height:auto;margin-top:10%;">
                    </div>                
    ...
    <script src="/inventario/Assets/js/barra.js"></script>
    <script src="/inventario/Assets/js/components/dos.js"></script>
