    ...
    methods: {
		checaSesion: function(){
			axios.get("/inventario/Controllers/inventarios.php",{
                ...
                if(result.data==0){
					document.location.href = "http://servermatrixxxb.ddns.net:8181/inventario/inventario.php?closeSession";
				}
            }).catch((err) => {
...
function closeSession(){
	window.open("http://servermatrixxxb.ddns.net:8181/inventario/inventario.php?closeSession")
}