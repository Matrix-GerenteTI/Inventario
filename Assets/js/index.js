...
let vmDashboard = new Vue({
    ...
    methods: {
        ...
        guardaInventario: function(conObservacion = false) {
            ...
            axios.post('/inventario/Controllers/inventarios.php', { inventario: resultadoInventario, action: action, tipo: self.tipoInventario, observacion: conObservacion == false ? '-' : this.observacionesHerramientas }).then((result) => {
                console.log(result);
