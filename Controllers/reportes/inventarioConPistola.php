...
require_once $_SERVER['DOCUMENT_ROOT']."/Inventario/Models/inventarios.php";
...
class InventarioConPistola extends PrepareExcel
{
    ...
    public function generarReporte( $mes , $anio)
    {
        ...
        $reporteTerminado->setIncludeCharts(TRUE);
         $reporteTerminado->save($_SERVER['DOCUMENT_ROOT']."/inventario/controllers/reportes/inventarioConPistola.xlsx");
        $ubicacion = "http://servermatrixxxb.ddns.net:8181/inventario/controllers/reportes/inventarioConPistola.xlsx";
